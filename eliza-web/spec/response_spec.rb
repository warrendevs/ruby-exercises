...
RSpec.describe 'Eliza answers' do
  ...
  Response.add_response ['baz', 'purple people'], 'baz1', 'baz2'
  ...
  describe 'Can retrieve answers' do
    ...
    it 'matches against the second element of an array of matchers' do
      expect(['baz1', 'baz2']).to include Response.get_answer('purple people')
    end
  end
end
